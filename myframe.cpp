...
bool MyFrame::hasBoundary(int linkId) { return links.contains(linkId); }

void MyFrame::removeBoundary(int linkId) { links.remove(linkId); }

int MyFrame::getFrameCount() { return frameCount; }

QGraphicsRectItem *MyFrame::getBoundary(int linkId) { return links[linkId]; }

QMap<int, QGraphicsRectItem *> MyFrame::getLinks() { return links; }
